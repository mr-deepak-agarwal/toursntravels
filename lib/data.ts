...
export const services = [
  ...
  },
  {
    ...
    desc: "North Goa and South Goa sightseeing, boat cruises, dinner cruises and adventure trips to Dudhsagar Waterfall, paced for explorers rather than checklists.",
    points: ["North & South Goa Tour", "Boat & Dinner Cruises", "Dudhsagar Waterfall Trip"],
    href: "/sightseeing",
  ...
  },
  {
    ...
    tag: "Beyond Goa",
    desc: "Budget-friendly, handcrafted escapes to Kullu-Manali-Shimla and Kashmir, planned end to end alongside our signature Goa holiday.",
    points: ["Kullu · Manali · Shimla", "Kashmir Paradise Tour", "Goa Signature Holiday"],
  ...
  },
  {
    ...
    tag: "Journeys of faith",
    desc: "Guided pilgrimage tours led with care and local knowledge, starting with the Ajmer Sharif Dargah yatra.",
    points: ["Ajmer Sharif Dargah", "Comfortable Travel & Stay", "Local Ziyarat Guidance"],
...
export const fleet = [
  ...
  {
    name: "SUV",
    example: "Innova Crysta / Scorpio / Fortuner",
    passengers: 7,
    luggage: 4,
    ac: true,
...
export const pilgrimages = [
  {
    slug: "ajmer-sharif-dargah-yatra",
